...
> This project is a ruby implementation of the Go Lang library found here: [https://github.com/rs/xid](https://github.com/rs/xid)

__I've included the ReadMe from that project here (with some modifications for ruby).__
